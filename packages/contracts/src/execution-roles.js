...
const AGENT_ROLES = Object.freeze({
  ...
  'the-britt': ROLES.manager,
  caretaker: ROLES.manager,
  'agent-vale': ROLES.executor,
  qra_sentinel: ROLES.executor,
  nyx: ROLES.executor,
  loom: ROLES.executor,
  rune: ROLES.executor,
  echo: ROLES.executor,
  wake_operator: ROLES.executor,
  aether_wlm: ROLES.executor,
  qra_emerge_orchestration: ROLES.executor,
  qra_emerge_ai_secops: ROLES.executor,
  qra_emerge_audit: ROLES.auditor,
  qra_emerge_context: ROLES.executor,
  qra_emerge_ethics_liaison: ROLES.executor,
  qra_emerge_mlops_data: ROLES.executor,
  qra_emerge_governance: ROLES.executor,
  qra_recovery_driver: ROLES.recovery,
  qra_route_controller: ROLES.executor,
  qra_signal_watch: ROLES.executor,
  sales_hunter: ROLES.executor,
  cluster_core_loop_captain: ROLES.manager,
  cluster_core_ship_lead: ROLES.executor,
  cluster_core_qc_sentinel: ROLES.executor,
  cluster_core_metrics: ROLES.executor,
  cluster_core_comms: ROLES.executor,
  ronan_v01: ROLES.executor,
});
