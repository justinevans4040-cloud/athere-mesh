...
const DEFAULT_BOUNDARIES = Object.freeze({
  'miss-vale-prime': Object.freeze({
    ...
    permittedTools: Object.freeze(['mission_supervise']),
    permittedStateAccess: Object.freeze(['mission.read', 'plan.read', 'evidence.read']),
    permittedMutationScope: Object.freeze(['plan.allocate', 'supervision.note']),
    executionBudget: Object.freeze({ max_state_mutations: 2, max_tool_calls: 4 }),
  }),
  'the-britt': Object.freeze({
    capabilityId: 'dangerous-authority-coholder',
    permittedTools: Object.freeze(['dangerous_authority_cohold']),
    permittedStateAccess: Object.freeze(['mission.read', 'authority.read']),
    permittedMutationScope: Object.freeze(['authority.note']),
  ...
  caretaker: Object.freeze({
    ...
    permittedTools: Object.freeze(['fleet_health']),
    permittedStateAccess: Object.freeze(['mission.read', 'fleet.read']),
    permittedMutationScope: Object.freeze(['fleet.note']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 4 }),
  }),
  'agent-vale': Object.freeze({
    capabilityId: 'ollama-chat',
    permittedTools: Object.freeze(['advisory_chat']),
    permittedStateAccess: Object.freeze(['mission.read']),
    permittedMutationScope: Object.freeze([]),
    executionBudget: Object.freeze({ max_state_mutations: 0, max_tool_calls: 4 }),
  }),
  qra_sentinel: Object.freeze({
    capabilityId: 'output-governor',
    permittedTools: Object.freeze(['screen_output']),
    permittedStateAccess: Object.freeze(['mission.read', 'output.read']),
    permittedMutationScope: Object.freeze(['output.screen']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  nyx: Object.freeze({
  ...
  loom: Object.freeze({
    ...
    permittedTools: Object.freeze(['resource_clearance']),
    permittedStateAccess: Object.freeze(['mission.read', 'resources.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  rune: Object.freeze({
  ...
  echo: Object.freeze({
    ...
    permittedTools: Object.freeze(['resonance_analyze']),
    permittedStateAccess: Object.freeze(['mission.read', 'signals.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  wake_operator: Object.freeze({
    capabilityId: 'configuration-engine',
    permittedTools: Object.freeze(['configure_wake']),
    permittedStateAccess: Object.freeze(['mission.read', 'config.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  aether_wlm: Object.freeze({
    capabilityId: 'execution-kernel',
    permittedTools: Object.freeze(['wlm_execute']),
    permittedStateAccess: Object.freeze(['mission.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  qra_emerge_orchestration: Object.freeze({
    capabilityId: 'system-integration-runner',
    permittedTools: Object.freeze(['system_integrate']),
    permittedStateAccess: Object.freeze(['mission.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  qra_emerge_ai_secops: Object.freeze({
    capabilityId: 'prompt-injection-defense',
    permittedTools: Object.freeze(['screen_injection']),
    permittedStateAccess: Object.freeze(['mission.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  ...
  qra_emerge_context: Object.freeze({
    capabilityId: 'context-memory-lock',
    permittedTools: Object.freeze(['lock_context']),
    permittedStateAccess: Object.freeze(['mission.read', 'memory.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  qra_emerge_ethics_liaison: Object.freeze({
    capabilityId: 'compliance-liaison',
    permittedTools: Object.freeze(['liaise_compliance']),
    permittedStateAccess: Object.freeze(['mission.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  qra_emerge_mlops_data: Object.freeze({
    capabilityId: 'data-pipeline-validator',
    permittedTools: Object.freeze(['validate_pipeline']),
    permittedStateAccess: Object.freeze(['mission.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  qra_emerge_governance: Object.freeze({
    capabilityId: 'policy-gatekeeper',
    permittedTools: Object.freeze(['gate_policy']),
    permittedStateAccess: Object.freeze(['mission.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  qra_recovery_driver: Object.freeze({
    ...
    permittedMutationScope: Object.freeze(['status.block', 'checkpoint.create', 'branch.create', 'branch.quarantine', 'checkpoint.rollback', 'checkpoint.retry']),
    executionBudget: Object.freeze({ max_state_mutations: 2, max_tool_calls: 4 }),
  }),
  qra_route_controller: Object.freeze({
    capabilityId: 'task-cluster-router',
    permittedTools: Object.freeze(['route_cluster']),
    permittedStateAccess: Object.freeze(['mission.read', 'cluster.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  qra_signal_watch: Object.freeze({
    capabilityId: 'port-watcher',
    permittedTools: Object.freeze(['watch_ports']),
    permittedStateAccess: Object.freeze(['mission.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  sales_hunter: Object.freeze({
    ...
    permittedTools: Object.freeze(['hunt_outbound', 'outreach_draft']),
    permittedStateAccess: Object.freeze(['mission.read', 'workspace.write']),
    permittedMutationScope: Object.freeze(['evidence.append', 'workspace.artifact']),
    executionBudget: Object.freeze({ max_state_mutations: 8, max_tool_calls: 40 }),
  }),
  cluster_core_loop_captain: Object.freeze({
    capabilityId: 'sprint-supervisor',
    permittedTools: Object.freeze(['supervise_sprint']),
    permittedStateAccess: Object.freeze(['mission.read', 'plan.read']),
    permittedMutationScope: Object.freeze(['plan.note']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  cluster_core_ship_lead: Object.freeze({
    capabilityId: 'hotfix-shipper',
    permittedTools: Object.freeze(['ship_hotfix']),
    permittedStateAccess: Object.freeze(['mission.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  cluster_core_qc_sentinel: Object.freeze({
    capabilityId: 'output-reviewer',
    permittedTools: Object.freeze(['review_output']),
    permittedStateAccess: Object.freeze(['mission.read', 'output.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  cluster_core_metrics: Object.freeze({
    capabilityId: 'metrics-logger',
    permittedTools: Object.freeze(['log_metrics']),
    permittedStateAccess: Object.freeze(['mission.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  cluster_core_comms: Object.freeze({
    capabilityId: 'stakeholder-comms',
    permittedTools: Object.freeze(['stakeholder_comms']),
    permittedStateAccess: Object.freeze(['mission.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
  ronan_v01: Object.freeze({
    capabilityId: 'forensic-investigator',
    permittedTools: Object.freeze(['investigate_forensics']),
    permittedStateAccess: Object.freeze(['mission.read']),
    permittedMutationScope: Object.freeze(['evidence.append']),
    executionBudget: Object.freeze({ max_state_mutations: 1, max_tool_calls: 2 }),
  }),
