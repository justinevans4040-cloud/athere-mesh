...
- Current action: permanent clean-commit control CLI and versioned Titan regression suite verified; committing them before executing the genuine repeated control
